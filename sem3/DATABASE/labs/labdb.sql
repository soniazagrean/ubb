...
END
GO
-- EXEC AddBakerPastry 8, 18, 'hfshj', 19.28;




-- ex 2
ALTER VIEW ViewFullMenu AS
SELECT 
...
EXEC AddBaker 'andrei', 'Italian'
EXEC AddPastry 'praji cu mere', 'Sicily'

EXEC AddBaker 'misu', 'Romanian'
EXEC AddPastry 'briosa', 'Sicily'
...
-- -- create link
EXEC AddBakerPastry @bId, @pId, 'cannoli', 12.00

-- -- raiserror called 
EXEC AddBakerPastry @bId, @pId, 'briosa', 12.00
...
-- insert address
INSERT INTO Addresses VALUES (888, 3, 'Rome St', 'Rome', 'Italy')
-- delete address
